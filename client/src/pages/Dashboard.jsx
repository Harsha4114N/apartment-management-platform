...
export default function Dashboard() {
  ...
  // Dummy state for tickets - replace with your actual MongoDB fetch logic
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans">
      ...
      <div className="max-w-3xl mx-auto flex justify-between items-center mb-8">
        ...
        <button className="bg-rose-500 hover:bg-rose-600 text-white px-5 py-2 rounded-xl font-medium transition-colors shadow-md shadow-rose-200">
          Logout
        </button>
      </div>
